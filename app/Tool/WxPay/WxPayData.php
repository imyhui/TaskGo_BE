 ...
 *
 */
class WxPayGetRsa extends WxPayDataBase
{
    /**
     * 设置签名方式
     * @param string $value
    ...
    public function isNonceStrSet(){
        return array_key_exists('nonce', $this->values);
    }
}
class WxPayToBank extends WxPayDataBase
{
    /**
     * @return mixed
     */
...
class WxPayResults extends WxPayDataBase
{
     ...
     * @throws WxPayException
     */
	public static function Init($xml,$rsa = false)
	{	
		$obj = new self();
		$obj->FromXml($xml);
		//fix bug 2015-06-29
